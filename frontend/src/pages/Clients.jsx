...
const Clients = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingClient) {
                await api.put(`tenants/clients/${editingClient.id}/`, formData);
            } else {
                await api.post('tenants/clients/', formData);
            }
            fetchClients();
            closeModal();
        } catch (error) {
    ...
    const openModal = (client = null) => {
        if (client) {
            ...
            setFormData({ name: '', subscription_plan: 'basic' });
        }
        setShowModal(true);
    };
                    ...
                    <div key={client.id} style={styles.card}>
                        <div style={styles.cardHeader}>
                            ...
                            <div style={styles.actions}>
                                <button onClick={() => openModal(client)} style={styles.iconButton}>
                                    <Edit2 size={16} />
                                </button>
                                <button onClick={() => handleDelete(client.id)} style={styles.iconButton}>
                                    <Trash2 size={16} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div style={styles.cardInfo}>
                            <Building size={14} />
                            <span>Plan: {client.subscription_plan}</span>
                        </div>
